...
export function getServers(p: {
  ...
  if (type === 'movie') {
    return [
      { id: 'server-1', name: 'Server 1', sandboxMode: 'balanced', url: `https://vidsrc.to/embed/movie/${id}` },
      ...
      { id: 'server-4', name: 'Server 4', sandboxMode: 'balanced', url: `https://autoembed.co/movie/tmdb/${id}` },
    ];
  }

  return [
    { id: 'server-1', name: 'Server 1', sandboxMode: 'balanced', url: `https://vidsrc.to/embed/tv/${id}/${s}/${e}` },
    ...
    { id: 'server-4', name: 'Server 4', sandboxMode: 'balanced', url: `https://autoembed.co/tv/tmdb/${id}-${s}-${e}` },
  ];
}
