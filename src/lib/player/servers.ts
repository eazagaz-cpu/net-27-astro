...
export function getServers(p: {
  ...
  if (type === 'movie') {
    return [
      ...
      { id: 'server-4', name: 'Server 4', sandboxMode: 'balanced', url: `https://vidsrc.to/embed/movie/${id}` },
    ];
  }
  ...
  return [
    ...
    { id: 'server-4', name: 'Server 4', sandboxMode: 'balanced', url: `https://vidsrc.to/embed/tv/${id}/${s}/${e}` },
  ];
}
